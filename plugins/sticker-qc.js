...
const pp = await conn.profilePictureUrl(who).catch((_) => 'https://files.catbox.moe/2txrtp.jpgpp')
...
const json = await axios.post('https://files.catbox.moe/2txrtp.jpgpp', obj, {headers: {'Content-Type': 'application/json'}});
